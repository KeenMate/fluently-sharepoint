...
namespace KeenMate.FluentlySharePoint.Extensions
{
	public static class Web
	{
		...
		public static CSOMOperation CreateWeb(this CSOMOperation operation, string name, uint? lcid, string url = "", string template = "")
		{
			...
			WebCreationInformation webInformation = new WebCreationInformation
			{
				...
				Language = (int) (lcid ?? operation.DecideWeb().Language)
			};
